...
// Copied from https://github.com/monix/minitest/blob/master/shared/src/main/scala-2/minitest/macros/SourceLocationMacros.scala
...
private[boon] trait SourceLocationMacros {
